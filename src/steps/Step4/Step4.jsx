...
import { ArrowRight, Circle, CircleUserRound, ImageOff, User } from 'lucide-react';
      ...
      <div className="greeting-content">
        <div className="greeting-avatar">
          {empleadoData?.foto ? (
            ...
            <CircleUserRound size={100} strokeWidth={0.8} className="avatar-icon" />
          )}
        </div>
        ...
        <h2 className="title">
          ¡Hola, {firstName}! <br />
          <br />
          Desde el equipo de Bienestar, queremos hacerte unas preguntas que nos ayudarán a
