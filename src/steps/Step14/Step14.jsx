  ...
  return (
    <div className="step step-admin-panel">
      <div className="admin-header">
        <button onClick={handleBackToFlow} className="btn-arrow">
          <ArrowLeft size={24} />
        </button>
        <h1 className="title">
          Solicitudes: {MOCK_APPLICATIONS.length} <br />
          Completadas: {MOCK_APPLICATIONS.filter(a => a.status === 'Completado').length}
        </h1>
      </div>
